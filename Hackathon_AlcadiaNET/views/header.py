...
def header() -> rx.Component:
    return rx.vstack(
        rx.heading("Welcome to, ArcadiaNET", size = "7", padding_bottom = Size.DEFAULT.value, color = TextColor.ACCENT.value),
        rx.flex(
            rx.image(
                src = "logo.png",
                alt = "ArcadiaNET logo", 
            ...
            rx.box(
                rx.text("Your gateway to the digital frontier of the 90's!", color = TextColor.TERCIARY.value),
            ),
            align_items = "start",
